...
from .exceptions import WebpackBundleLookupError, WebpackError, WebpackLoaderBadStatsError, WebpackLoaderTimeoutError
...
class WebpackLoader:
    ...
    def get_chunk_url(self, chunk_file):
        ...
        relpath = os.path.normpath(os.path.join(self.config["BUNDLE_DIR_NAME"], chunk_file["name"]))
    ...
    def get_bundle(self, bundle_name):
        ...
        if assets.get("status") == "done":
            ...
            for chunk in filtered_chunks:
                ...
                if asset is None:
                    raise WebpackBundleLookupError(f"Cannot resolve asset {chunk}.")
